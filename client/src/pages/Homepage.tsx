...
const Homepage = () => {
    return (
        <section>
            <nav className="w-max flex pt-16 text-gray-700" aria-label="Breadcrumb">
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <a href="#" className="ms-1 text-md font-medium text-gray-700 hover:text-blue-600">Templates</a>
                        </div>
                    </li>
